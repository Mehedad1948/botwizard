...
export function LandingHero() {
  return (
    <section className="landing-frame-background sticky top-0 z-0 flex h-svh items-center justify-center overflow-hidden p-3 py-8 sm:px-5 sm:py-10 lg:py-20">
      <div
        aria-hidden="true"
      ...
      <div className="relative flex h-full min-h-0 flex-1 flex-col overflow-visible bg-white">
        <LandingNotch className="absolute bottom-full min-h-5 translate-y-0.5" />
        <LandingNotch className="absolute top-full -translate-y-0.5 -scale-y-100" />
          ...
          <div className="relative z-10 flex items-start px-6 pt-2 sm:px-12 sm:pt-3 lg:order-1 lg:items-center lg:px-14 lg:py-8 xl:px-20">
            <div className="mx-auto w-full max-w-xl lg:mx-0">
              ...
              <p className="mt-4 max-w-lg text-sm leading-6 text-slate-500 sm:mt-6 sm:text-base sm:leading-8 lg:text-lg">
                ربات‌ها، محتوا و کمپین‌هایتان در تلگرام و بله را از یک داشبورد
                ساده مدیریت کنید؛ شما ایده بدهید، BotWizard درست سر وقت منتشر
                می‌کند.
              </p>
